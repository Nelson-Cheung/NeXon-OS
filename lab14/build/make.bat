...
pause
echo 编译内核(c++实现的内核代码)
%COMPLIE_TOOL_DIR%\g++.exe -O0 -march=i386 -m32 -c %SRC_DIR%\kernel.cpp %SRC_DIR%\datastructure\bitmap.cpp
pause
echo 链接内核
%COMPLIE_TOOL_DIR%\ld.exe -melf_i386 -N kernel_asm.o kernel.o bitmap.o -Ttext 0xc0020000  --oformat binary -o kernel.bin
